...
const FAQ = [
...

  {
    ...
    a: `Pišite na ${CONTACT_EMAIL} ili posjetite stranicu Kontakt na /contact.`,
...
export function SeoEnhancements() {
  ...
  useEffect(() => {
    ...
    injectJsonLd("ld-reviewer", {
      "@context": "https://schema.org",
      "@type": "Person",
      "@id": `${SITE_URL}#reviewer`,
      name: "Imam Afrim Osmani",
      jobTitle: "Islamic content reviewer",
      worksFor: { "@type": "Organization", name: SITE_NAME, url: SITE_URL },
      knowsAbout: ["Islamic catechism", "Sunni theology", "Children's religious education"],
    });
