...
export const translations: Translations = {
  ...
  cartoons: {
    ...
    exitFullscreen: {
      en: 'Exit Fullscreen',
      bs: 'Izađi iz punog ekrana',
      sq: 'Dil nga ekrani i plotë',
    ...
    islamicAnimalsTitle: {
      en: 'Islamic Animals Stories for Kids',
      bs: 'Islamske priče o životinjama za djecu',
      sq: 'Histori islamike të kafshëve për fëmijë',
      de: 'Islamische Tiergeschichten für Kinder',
      it: 'Storie di animali islamici per bambini'
    },
    islamicAnimalsDescription: {
      en: 'Educational stories about animals mentioned in the Quran and Islamic teachings.',
      bs: 'Edukativne priče o životinjama spomenutim u Kuranu i islamskim učenjima.',
      sq: 'Histori edukative për kafshë të përmendura në Kuran dhe mësimet islamike.',
      de: 'Lehrreiche Geschichten über Tiere, die im Koran und in islamischen Lehren erwähnt werden.',
      it: 'Storie educative su animali menzionati nel Corano e negli insegnamenti islamici.'
    },
    prophetStoriesTitle: {
      en: 'Prophet Stories for Children',
      bs: 'Priče o poslanicima za djecu',
      sq: 'Histori të profetëve për fëmijë',
      de: 'Prophetengeschichten für Kinder',
      it: 'Storie dei profeti per bambini'
    },
    prophetStoriesDescription: {
      en: 'Beautiful animated stories about the prophets mentioned in the Quran.',
      bs: 'Prekrasne animirane priče o poslanicima spomenutim u Kuranu.',
